...
/////////////////////////////
    ...
    ///////////////////
        ...
        let selectableElements = ["Fe", "Sr", "Y", "Zr", "Nb", "Pd", "Ag", "Eu", "Tb", "Tm", "Hf", "Ir"];
            ...
            let tip = d3.tip().attr('class', 'd3-tip')
                ...
                .html((d)=>{
                    ...
                    let tooltip_data = {
                        ...
                        "info":[
                        {"entry": "Big Bang Fusion: "+(parseInt(d.BigBangFusion * 100))+"%", "type": "BigBangFusion"},
                        {"entry": "Cosmic Ray Fission: "+(parseInt(d.CosmicRayFission * 100))+"%", "type": "CosmicRayFission"},
                        {"entry": "Merging Neutron Stars (r-process): "+(parseInt(d.MergingNeutronStars * 100))+"%", "type": "MergingNeutronStars"},
                        {"entry": "Exploding Massive Stars: "+(parseInt(d.ExplodingMassiveStars * 100))+"%", "type": "ExplodingMassiveStars"},
                        {"entry": "Dying Low Mass Stars (s-process): "+(parseInt(d.DyingLowMassStars * 100))+"%", "type": "DyingLowMassStars"},
                        {"entry": "Exploding White Dwarfs: "+(parseInt(d.ExplodingWhiteDwarfs * 100))+"%", "type": "ExplodingWhiteDwarfs"}
                        // for s- and r-process
